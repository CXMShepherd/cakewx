...
echo $this->Main->formhr_input('FType', array(
		'div' => "form-group", 
		'options' => array('0' => "图文", '1' => "商品"),
		'label' => array('text' => "类型：", 'class' => "col-sm-3 control-label no-padding-right"), 
		'type' => "select", 
		'placeholder' => "", 
		'class' => "col-xs-10 col-sm-5 tpSelect",
...
echo $this->Main->formhr_input('FStore', array(
		...
		'label' => array('text' => "商铺：", 'class' => "col-sm-3 control-label no-padding-right"), 
		'type' => "select", 
		'placeholder' => "", 
