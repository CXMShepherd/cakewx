<?php
	...
	// Tips
	$this->start('tbtips');
	echo $this->element('Admin/tips', array('tips' => '店铺的分类地址：'.$this->Html->link($storeIndexUrl, $storeIndexUrl, array('target' => "_blank"))), array('cache' => array('config' => "short")));
	$this->end('tbtips');
...
<div style="margin-bottom:15px">
	<div class="btn-group">
		...
		<ul class="dropdown-menu">
			<li><?php echo $this->Html->link('添加分类', "{$WC_URL}?_m=tw&_a=add"); ?></li>
		</ul>
	</div>
</div>
<div class="a_types">
