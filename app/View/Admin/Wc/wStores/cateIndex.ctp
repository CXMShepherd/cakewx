...
<?php echo $data['storeList']['WxDataStore']['FName']; ?>：
</h3>
<?php $this->end(); ?>
								...
								<tr>
									...
									<td>
										<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
											...
											<button class="btn btn-xs btn-danger bootbox-confirm" alt="<?php echo "{$view['baseurl']}&_a=del&_cid={$vals['WxDataCate']['Id']}" ?>">
