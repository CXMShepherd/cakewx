...
<div style="margin-bottom:15px">
	<div class="btn-group">
		...
		<ul class="dropdown-menu">
			<li><?php echo $this->Html->link('单图文', "{$WC_URL}?_m=tw&_a=add"); ?></li>
			<li><?php echo $this->Html->link('多图文', "{$WC_URL}?_m=twj&_a=add"); ?></li>
			<!--<li class="divider"></li>
			<li><?php echo $this->Html->link('活动', "{$WC_URL}?_m=event&_a=add"); ?></li>-->
		</ul>
	</div>
</div>
<div class="a_types">
