...
<div class="singleitem cl">
    ...
    <?php
		...
		echo $this->Main->formhr_input('FReLink', array(
	    'div' => "form-group",
	    'label' => array('text' => "原文链接：", 'class' => "col-sm-2 control-label no-padding-right"),
	    'type' => "text",
	    'placeholder' => "",
	    'class' => "col-xs-10 col-sm-12",
	    'between' => "<div class='col-xs-12 col-sm-9'><div class='clearfix'>",
...
<!-- LeftTabContent Start -->
<?php $this->start('leftTabContent'); ?>
	<div id="lhome" class="tab-pane active">
		<?php
			echo $this->Main->formhr_input('FReLink', array(
		    	'div' => "form-group",
				'options' => $data['cates'],
			    'label' => array('text' => "选择分类：", 'class' => "col-sm-2 control-label no-padding-right"),
			    'type' => "select",
				'multiple' => "checkbox",
			    'placeholder' => "",
			    'class' => "col-xs-10 col-sm-12",
	...
	<div id="ldp001" class="tab-pane">
		<?php
			echo $this->Main->formhr_input('FReLink', array(
		    	'div' => "form-group",
				'options' => $data['cates'],
			    'label' => array('text' => "选择菜单：", 'class' => "col-sm-2 control-label no-padding-right"),
			    'type' => "select",
				'multiple' => "checkbox",
			    'placeholder' => "",
			    'class' => "col-xs-10 col-sm-12",
	...
	<div id="ldp002" class="tab-pane">
		<?php
			echo $this->Form->label('FReLink', '是否开启评论：', array('class' => 'col-sm-2 control-label no-padding-right no-padding-top'));
			echo $this->Main->formhr_input('FReLink', array(
				'div' => "form-group col-xs-12 col-sm-9",
				'options' => array('1' => "开放", '0' => "关闭"),
				'type' => "radio",
			    'placeholder' => "",
				'hiddenField' => FALSE,
				'legend' => FALSE,
				'default' => "1",
				'class' => "col-xs-10 col-sm-12",
				'before' => "<div class='col-xs-12 col-sm-9'><div class='clearfix'>",
				'separator' => "</div></div><div class='col-xs-12 col-sm-9'><div class='clearfix'>",
			    'between' => "</div></div>",
			    'after' => "</div></div>",
			    'error' => array('attributes' => array('wrap' => 'div', 'class' => 'help-block col-xs-12 col-md-offset-2'))
			));
...
<?php $this->end(); ?>
<?php echo $this->element('Admin/leftTab', array('nav' => $data['leftNav']), array('cache' => array('config' => "short"))); ?>
