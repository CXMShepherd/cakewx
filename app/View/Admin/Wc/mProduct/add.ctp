...
<div class="singleitem cl">
    ...
    <div class="formput fl" style="width:650px;">
        ...
        echo $this->Main->formhr_input('WxDataTw.FTitle', array(
				'div' => "form-group", 
				'label' => array('text' => "商品名称：", 'class' => "col-sm-2 control-label no-padding-right"),
				'type' => "text", 
				'placeholder' => "", 
		...
		echo $this->Main->formhr_input('WxDataTwProduct.FAddress', array(
				'div' => "form-group", 
				'label' => array('text' => "产地：", 'class' => "col-sm-2 control-label no-padding-right"),
				'type' => "text", 
				'placeholder' => "", 
				'class' => "col-xs-10 col-sm-5",
				'between' => "<div class='col-xs-12 col-sm-9'><div class='clearfix'>",
		...
		echo $this->Main->formhr_input('WxDataTwProduct.FOrigPrice', array(
				'div' => "form-group", 
				'label' => array('text' => "原价：", 'class' => "col-sm-2 control-label no-padding-right"),
				'type' => "text", 
				'placeholder' => "", 
				'class' => "col-xs-10 col-sm-5",
				'between' => "<div class='col-xs-12 col-sm-9'><div class='clearfix'>",
		...
		echo $this->Main->formhr_input('WxDataTwProduct.FPrice', array(
				'div' => "form-group", 
				'label' => array('text' => "现价：", 'class' => "col-sm-2 control-label no-padding-right"),
				'type' => "text", 
				'placeholder' => "", 
				'class' => "col-xs-10 col-sm-5",
				'between' => "<div class='col-xs-12 col-sm-9'><div class='clearfix'>",
		...
		echo $this->Main->formhr_input('WxDataTwProduct.FUnit', array(
				'div' => "form-group", 
				'options' => array('份' => "份", '斤' => "斤", '个' => "个"),
				'label' => array('text' => "规格：", 'class' => "col-sm-2 control-label no-padding-right"),
				'type' => "select", 
				'placeholder' => "", 
				'class' => "col-xs-10 col-sm-5",
				'between' => "<div class='col-xs-12 col-sm-9'><div class='clearfix'>",
		...
		echo $this->Main->formhr_input('WxDataTw.FLink', array(
    		'div' => "form-group",
		    'label' => array('text' => "商品链接：", 'class' => "col-sm-2 control-label no-padding-right"),
			'type' => "text",
		    'placeholder' => "",
		    'class' => "col-xs-10 col-sm-5",
		    'between' => "<div class='col-xs-12 col-sm-9'><div class='clearfix'>",
		    'after' => "<span class='help-inline col-xs-12 col-sm-2'><span class='middle maroon'></span></span></div><div style='color:red;margin-top:5px;'>（针对其他互联网店铺商品的外链）</div></div>",
		    'error' => array('attributes' => array('wrap' => 'div', 'class' => 'help-block col-xs-12 col-md-offset-2'))
	    ));
		echo $this->Main->formhr_input('WxDataTwProduct.FIsClosed', array(
    		'div' => "form-group",
			'options' => array('0' => '正常销售', '1' => "暂停销售", ),
		    'label' => array('text' => "是否暂停销售：", 'class' => "col-sm-2 control-label no-padding-right"),
			'type' => "select",
		    'placeholder' => "",
...
<?php echo $this->Form->hidden('WxDataTw.FTwType', array('id' => "FTwType", 'value' => "product")); ?>
