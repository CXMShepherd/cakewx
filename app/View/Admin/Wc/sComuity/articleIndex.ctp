								...
								<tr>
									...
									<td>
										<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
											<?php $adf = $vals['WxDataCate']['A_DF'] ? "&_val=".$vals['WxDataCate']['FName'] : ''; ?>
											<button class="btn btn-xs btn-info" onclick="parent.location.href='<?php echo "{$view['baseurl']}&_a=edit&_cid={$vals['WxDataCate']['Id']}{$adf}" ?>'">
