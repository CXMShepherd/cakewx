...
<div class="row">
	<div class="col-sm-12">
		...
		<div class="well">
			<h4 class="blue smaller lighter"><?php echo $this->Html->link('活动', "{$WC_URL}?_m=event&_a=add"); ?></h4>
			发布活动类型的单图文，活动详细页展示您定义的活动，有刮刮卡，大转盘，优惠券，及活动报名，成员审核，活动管理等。
		</div>
		<div class="well">
			<h4 class="blue smaller lighter"><?php echo $this->Html->link('商品', "{$WC_URL}?_m=product&_a=add"); ?></h4>
			发布商品类型的单图文，展示您的商品，水果，蔬菜，外卖，以及购物车，订单管理等。
		</div>
		<div class="well">
			<h4 class="grey smaller lighter">投票（即将上线）</h4>
			发布投票，用户可以投票该自定义内容，可以查看投票结果。
		</div>
		<div class="well">
			<h4 class="grey smaller lighter">问卷调查（即将上线）</h4>
			发布问卷调查，用户可以填写问卷调查，您可以得到调查反馈。
		</div>
		<div class="well">
			<h4 class="grey smaller lighter">在线预定（即将上线）</h4>
			发布预定，用户可以预定您的项目，并且您可以查看用户填写的内容，并第一时间取得联系。
		</div>
		<div class="well">
			<h4 class="grey smaller lighter">在线留言（即将上线）</h4>
