...
!(function () {
  ...
  var PUSH = function (options) {
    ...
    xhr.onreadystatechange = function () {
      ...
      if (xhr.readyState === 4) {
        //|| (xhr.status == 0 && options.url.indexOf('file:///') != -1) 额外条件
  ...
  var success = function (xhr, options) {
    ...
    /*
    var jscustom = data.contents.querySelectorAll('script.js-custom');
    console.dir(jscustom);
    for(var i = 0; i < jscustom.length; ++i) {
        eval(jscustom[i].innerHTML);
    }
    */
